   ...
   ?>
    ...
    <div class="mx-auto max-w-7xl">
        ...
        if($stmt && $stmt->rowCount() > 0){
            ...
            ?>
                <div class="">
                    <img class="w-full h-auto" src="imgs/<?= $imagem ?>" alt="Evento <?= $id ?>">
                    <div class="my-1 font-semibold">29.11</div>
                    <div class="font-light mb-4"><?= $nome ?></div>
                    <a href="evento.php?evento=<?= $id ?>" class="inline-flex items-center gap-2 p-2 border border-[rgb(56,142,60)] text-[rgb(76,175,80)] hover:bg-[rgb(56,142,60)] hover:text-white">
        ...
        <?php         
            }// do while de cada evento
        } // do if de haver ecventos
        ?>
        </div>
