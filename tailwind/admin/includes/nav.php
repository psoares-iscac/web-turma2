<aside id="sidebar" class="w-64 bg-gray-800 text-white flex-shrink-0 
            ...
            <nav class="flex-grow p-4 space-y-2">
                ...
                <a href="eventos.php" class="flex items-center p-3 rounded-lg bg-gray-700 text-indigo-200 font-medium group">
                ...
                <a href="utilizadores.php" class="flex items-center p-3 rounded-lg hover:bg-gray-700 transition duration-150 ease-in-out font-medium group">
                    <svg class="w-5 h-5 mr-3 text-green-300 group-hover:text-green-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H9a2 2 0 01-2-2v-1a2 2 0 012-2h6a2 2 0 012 2v1a2 2 0 01-2 2z"></path></svg>
